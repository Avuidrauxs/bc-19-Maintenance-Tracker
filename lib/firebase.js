...
var staff = new user.Users('John','SpringRoll','Dollar','qwerty','banku@skin.com','sta',true);
var mainte = new maintenance.Maintenance(001,'Car repair','11/11/2016',78,'high','repair',true);
